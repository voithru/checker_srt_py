...
class ErrorSettingsWindow(tb.Toplevel):  # tb.Toplevel으로 변경
    ...
    def create_widgets(self):
        ...
        error_descriptions = {
            "줄당 자수": ("각 줄이 최대 문자 수를 초과하는지 확인합니다.", "이것은 매우매우 매우매우 매우매우 매우매우 매우매우 매우매우 긴 문장입니다."),
            ...
            "첫번째 자막": ("첫 번째 자막의 시작 시간과 텍스트를 확인합니다.", "시작 시간: 0~5.0초\n텍스트: 설정된 텍스트와 정확히 일치"),
        }

        error_notes = {
            "줄당 자수": "KOR: 35, ENG: 46, JPN: 24, CHN: 20\nSPA: 42, VIE: 42, IND: 55, THA: 42\n\nJPN, CHN의 경우 영문자와 공백은 0.5자 취급",
            "줄 수": "2줄까지 정상, 3줄 이상 에러",
